      ...
      <div className="stars flex flex-col justify-center items-center border-cyan-400">
        ...
        <div className='flex flex-1 h-5/6 w-5/6 justify-around justify-center items-center'>
          ...
          <div className='w-3/6 h-5/6 rounded-lg border-2 border-cyan-500'>
						<div className="text-4xl text-center text-white m-8"> Reporte Aviones</div>
							<div className="text-2xl  text-cyan-500 m-8">
                <Table aria-label="Tabla de vuelos">
                  <TableHeader className='text-black'>
                    <TableColumn className='text-black'>Modelo Avion</TableColumn>
                    <TableColumn className='text-black'>Marca</TableColumn>
                    <TableColumn className='text-black'>Año</TableColumn>
                    <TableColumn className='text-black'>Cantidad de Pasajeros</TableColumn>
                    <TableColumn className='text-black'>Cantidad de Vuelos</TableColumn>
                  </TableHeader>
                  <TableBody>
